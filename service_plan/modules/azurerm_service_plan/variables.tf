...
variable "app_service_environment_id" {
  description = "The ID of the App Service Environment to create this Service Plan in. Requires an Isolated SKU."
  type        = string
  default     = null
}
...
variable "subscription_id" {
  description = "The Subscription ID where the Service Plan should exist."
  type        = string
}
